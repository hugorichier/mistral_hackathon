...
class Event(BaseModel):
    ...
    end_date: str | None = Field("", description="Reference end day of occuring event.")
    description: str = Field("Short description of the event.")
    participants: list[str] = Field(
        description="List of participants in the event, can be individuals or groups of people."
    )
