...
from ..environement import GCLOUD_PROJECT_ID, CHUNK_TOPIC
from ..schemas import ConversationChunk, ConversationInfo


_EXAMPLE_CHUNK = """**Therapist**: How are you doing today?
